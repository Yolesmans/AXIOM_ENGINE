# 📊 DIFF PROMPTS vs COMPORTEMENT RÉEL — AXIOM / REVELIOM

**Date** : 2025-01-27  
**Objectif** : Liste exhaustive des écarts entre les prompts REVELIOM et le comportement réel du système
...
**Promesse prompt** (`src/engine/prompts.ts:726-740`) :
...
**Promesse prompt** (`src/engine/prompts.ts:156-179`) :
...
**Promesse prompt** (`src/engine/prompts.ts:507-511`) :
