...
class CandidateStore {
     ...
     */
    deriveBlock2StateFromAnswers(candidate) {
        ...
        const hasAny2A = !!(block2A && (block2A.medium || block2A.preference || block2A.coreWork));
     ...
     */
    async ensureBlock2StateAndPersistIfNeeded(candidateId) {
