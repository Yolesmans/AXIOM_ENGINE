 ...
 */
export async function adaptToMentorStyle(rawText, contextType = 'mirror') {
 ...
 */
function getReformulationPrompt(rawText, contextType) {
 ...
 */
function getStrictReformulationPrompt(rawText, contextType, retryCount) {
